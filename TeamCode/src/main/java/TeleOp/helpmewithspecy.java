...
@Config
@TeleOp
public class helpmewithspecy extends LinearOpMode {
...
buttons state = buttons.complete;
 ...
 public static double close = 0, hoverwrist = .65,  clawopen =1, wristbasket = .4,wristnotyet = .5, wristspecimen = .5 , hoverspecimen = .575, wristconfirm = .6;
...
//                 pivotL.setPosition(.3);
                ...
                case pickupspecemine:
                    ...
                    if(slides.left.getCurrentPosition()>700){
                        pivotR.setPosition(.06);
                        pivotL.setPosition(.06);
                        wrist.setPosition(hoverspecimen);
                        hand.setPosition(clawopen);
                        turnposition=.7;
                        state = buttons.pitup;
                    }
